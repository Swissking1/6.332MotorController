...
CUBE_DIR = ./lib/stm32f413libs

# linker script
LD_SCRIPT = linker/STM32F413ZHTx_FLASH.ld
...
INC_DIRS = inc $(CUBE_DIR)/cmsis_inc $(CUBE_DIR)/cmsis_dev_inc $(CUBE_DIR)/hal_inc
...
# flags for linker
LD_FLAGS = -T$(LD_SCRIPT) -g -Wl,-Map=$(OUT_DIR_F)$(PROJECT).map,--cref --specs=nosys.specs
